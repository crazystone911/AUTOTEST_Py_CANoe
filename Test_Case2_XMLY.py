...
class CanoeSync(object):
    ...
    def click_XMLY(self):
        subprocess.run(f"adb shell input tap {367} {335}", shell=True)
        time.sleep(3)
        subprocess.run(f"adb shell input tap {782} {325}", shell=True)
        time.sleep(3)
        subprocess.run(f"adb shell input tap {384} {307}", shell=True)
        time.sleep(3)
        subprocess.run(f"adb shell input tap {1241} {240}", shell=True)
